...
$string = "
            <div class=\"page-title\">
                          ...
                          <h3>KELOLA DATA ".  strtoupper($table_name)."</h3>
              </div>
...
$string .= "\n\t\t\t<td style=\"text-align:center\" width=\"200px\">"
        ...
        . "\n\t\t\t\techo '  '; "
        . "\n\t\t\t\techo anchor(site_url('".$c_url."/update/'.$".$c_url."->".$pk."),'<i class=\"fa fa-pencil-square-o\" aria-hidden=\"true\"></i>','class=\"btn btn-primary btn-sm\"'); "
        . "\n\t\t\t\techo '  '; "
